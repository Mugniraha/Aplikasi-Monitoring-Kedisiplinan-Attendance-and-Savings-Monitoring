...
<body>
    <div id="content" class="">
        ...
        <div class="mt-32 p-2 rounded-r-md w-48 bg-teal-550">
            <span class="text-white font-bold">Absensi</span>
        </div>
            ...
            <div class="bg-white shadow-smml-4 m-5 rounded-md p-5">
                ...
                <div class="grid grid-cols-1 ml-14 md:grid-cols-6 gap-4 justify-center">
                    @foreach ($siswa as $datasiswa)
                        <div href="" class="bg-white p-5 w-48 rounded-2xl border-2 border-gray-300 shadow-xl">
                            ...
                            <div class="mt-4 text-center">
                                <a href="{{route('detailAbsenPerSiswa.show', $datasiswa->id_siswa)}}" class="inline-block p-3 rounded-md bg-teal-550 text-white">
                                    Hadir 90%
                                </a>
                            </div>
                        </div>
